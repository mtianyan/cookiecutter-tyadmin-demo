...
import {addBgqInfo, queryBgqInfo, removeBgqInfo, updateBgqInfo} from './service';
...
const TableList = () => {
  ...
  try {
    await updateBgqInfo(value, current_id);
    hide();
    ...
    <PageHeaderWrapper>
      <ProTable
        ...
        toolBarRender={(action, {selectedRows}) => [
          ...
          <Input.Search style={{marginRight: 20}} placeholder="搜索办公区 " onSearch={value => {
            setParamState({
              search: value,
            });
        ...
        request={(params, sorter, filter) => queryBgqInfo({...params, sorter, filter})}
