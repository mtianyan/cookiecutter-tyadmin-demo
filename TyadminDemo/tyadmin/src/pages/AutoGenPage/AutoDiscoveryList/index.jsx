...
import {addAutoDiscovery, queryAutoDiscovery, removeAutoDiscovery, updateAutoDiscovery} from './service';
import UpdateForm from './components/UpdateForm';
import UploadAvatar from '@/components/UploadAvatar';
import {queryBgqInfo} from '@/pages/AutoGenPage/BgqInfoList/service';
...
const TableList = () => {
  ...
  try {
    await updateAutoDiscovery(value, current_id);
    hide();
    ...
    <PageHeaderWrapper>
      <ProTable
        ...
        toolBarRender={(action, {selectedRows}) => [
          ...
          <Input.Search style={{marginRight: 20}} placeholder="搜索自动发现 " onSearch={value => {
            setParamState({
              search: value,
            });
        ...
        request={(params, sorter, filter) => queryAutoDiscovery({...params, sorter, filter})}
