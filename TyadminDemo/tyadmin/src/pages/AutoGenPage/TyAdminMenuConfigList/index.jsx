...
const TableList = () => {
  ...
  return (
    <PageHeaderWrapper>
        ...
        headerTitle="ty admin menu config表格"
        actionRef={actionRef}
        rowKey="id"
        toolBarRender={(action, {selectedRows}) => [
          ...
          <Input.Search style={{marginRight: 20}} placeholder="搜索ty admin menu config " onSearch={value => {
            setParamState({
              search: value,
            });
        ...
        request={(params, sorter, filter) => queryTyAdminMenuConfig({...params, sorter, filter})}
