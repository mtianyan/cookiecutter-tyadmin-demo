    ...
    queryMenu().then(data => {
      ...
      menuData.map((item)=>{
        if(item.routes !== undefined){
          if(item.iconStr){
            item.icon = <DynamicIcon type={item.iconStr} />
          }else {
  ...
  return (
    <ProLayout
      ...
      menuItemRender={(menuItemProps, defaultDom) => {
        ...
        console.log('xxx', menuItemProps.icon);
        return <Link to={menuItemProps.path}>
          {menuItemProps.icon?<DynamicIcon type={menuItemProps.icon} />:<DynamicIcon type={menuItemProps.iconStr} />}
          {defaultDom}
        </Link>;
      }}
